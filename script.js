...
if(latTexto)
latTexto.textContent=formatoGPS(centro.lat,"lat");


if(lngTexto)
lngTexto.textContent=formatoGPS(centro.lng,"lng");
...
const tarjetasPeces=document.querySelectorAll(".pezCard");
...
let texto=buscarPez.value
.toLowerCase()
.trim();


let filtro=filtroPez.value;
...
let nombre=pez
.querySelector(".peznombre")
.textContent
.toLowerCase();



let tipo=pez.dataset.tipo||"";
